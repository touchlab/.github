...
Requests with a lot of community support are more likely to be considered. It also provides distinct spaces for defects (issues) which are concretely fixable, and enhancements which may be valid but not prioritized.
